...
import { PrivacyPolicyAttributes } from '@/components/lib/types';
...
interface PrivacyPolicyTemplateProps {
    data: PrivacyPolicyAttributes;
    lang: string;
}


export default function PrivacyPolicyTemplate({ data, lang }: PrivacyPolicyTemplateProps) {
