...
import { CookiePolicyAttributes } from '@/components/lib/types';
import PolicySection from '../../organisms/sections/PolicySection';



interface CookiesPolicyTemplateProps {
    data: CookiePolicyAttributes;
    lang: string;
}


export default function CookiesPolicyTemplate({ data, lang }: CookiesPolicyTemplateProps) {
