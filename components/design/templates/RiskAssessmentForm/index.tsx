...
const translations = {
    ...
    ar: {
        ...
        sectionOrg: "معلومات المنشأة والتواصل",
        ...
        facilityTypeLabel: "ما هو نوع المنشأة التي تديرها؟",
        facilityTypeOptions: [
            "منشأة صناعية",
            "مصنع / تصنيع",
            "النفط والغاز",
            "الخدمات اللوجستية / مستودعات",
            "مبنى تجاري",
            "مشروع أبراج / مبانٍ شاهقة",
            "مشروع قيد الإنشاء",
            "مركز بيانات",
            "مطار",
            "رعاية صحية / مستشفى",
        ...
        facilitySizeLabel:
            "كم عدد الأشخاص المتواجدين في الموقع عادةً تقريباً؟",
        facilitySizeOptions: [
        ...
        projectStageLabel: "ما هي مرحلة مشروعك الحالية؟",
        projectStageOptions: [
            { value: "operational", label: "منشأة تشغيلية قائمة" },
            { value: "construction", label: "قيد الإنشاء" },
            {
                value: "new-development",
                label: "مشروع جديد (مكتمل ولكن غير مشغل بعد)",
            },
            { value: "design", label: "مرحلة التصميم" },
            { value: "tender", label: "مرحلة المناقصات / العطاءات" },
        ],

        sectionHazards: "ملف المخاطر والأخطار",
        hazardsLabel: "ما هي المخاطر الموجودة في موقعك؟",
        hazardsHint: "(حدد كل ما ينطبق)",
        hazardOptions: [
            "مبانٍ شاهقة الارتفاع",
            "مواد خطرة",
            "تخزين الوقود أو الغاز",
            "عمليات صناعية ثقيلة",
            "أماكن مغلقة / محصورة",
            "العمل في الأماكن المرتفعة",
            "مرافق تحت الأرض",
            "موقع ناءٍ / بعيد",
            "مخاطر مرتبطة بالإنشاءات",
            "فعاليات جماهيرية كبرى",
            "لا يوجد أي مما ذكر",
        ],

        sectionReadiness: "جاهزية السلامة من الحرائق وحماية الحياة الحالية",
        emergencyServiceLabel:
            "هل لديك حالياً خدمة إطفاء وإنقاذ في حالات الطوارئ؟",
        emergencyServiceOptions: [
            { value: "in-house", label: "نعم – فريق داخلي" },
            { value: "outsourced", label: "نعم – خدمة خارجية معتمدة" },
            { value: "no", label: "لا" },
            { value: "under-review", label: "قيد المراجعة حالياً" },
        ],

        preRiskAssessmentLabel:
            "هل لديك تقييم لمخاطر الحرائق (Fire Risk Assessment) لموقعك مكتمل من قبل استشاري معتمد لدى الدفاع المدني؟",
        preRiskAssessmentOptions: [
            { value: "yes", label: "نعم" },
            { value: "no", label: "لا" },
        ],
        ...
        servicesLabel: "ما هي الخدمات التي تهتم بها؟",
        servicesHint: "(حدد كل ما ينطبق)",
        servicesOptions: [
            "خدمات الإطفاء والإنقاذ",
            "الاستجابة للطوارئ على مدار 24/7",
            "تقييم مخاطر الحرائق",
            "الجاهزية والاستعداد للطوارئ",
            "التفتيش والتدقيق على سلامة الحرائق",
            "إدارة محطات الإطفاء",
            "السلامة من الحرائق للمجتمع",
            "الامتثال لمتطلبات الدفاع المدني",
            "مراجعة الضمان التشغيلي",
        ],
