...
const socialLinks = [
    ...
    { icon: "wt", href: WHATSAPP_URL, label: "Chat" },
];
...
const SocialIcon = ({ type }: { type: string }) => {
    const icons: Record<string, React.ReactElement> = {
        ...
        wt: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
                            ...
                            if (social.icon === 'wt') {
                                return (
                                    <button
                                        ...
                                        aria-label={isArabic ? 'فتح نافذة الاستفسار' : 'Open inquiry chat'}
